...
function Mentions() {
  ...
  const information = {
    siteLink: " https://www.yannickperia.com ",
    companyName: " Yannick Perianayagom-Mary",
    ownerName: " Yannick Perianayagom-Mary ",
    email: " yannickperia@gmail.com ",
    phone: " 06 92 32 86 86",
    address: " 	29 B RUE DE BORDEAUX 97420 LE PORT",
    hostName: "Hostinger",
  ...
  return (
    <div className="mentions-container">
      ...
      <p>
        ...
        détenues par
        <a href={information.siteLink}>{information.siteLink}</a>
        pour la gestion de votre compte, de la gestion de la relation client et
        à des fins d’analyses et de statistiques.
      </p>
      <p>
      ...
      <p>
        <strong>Propriétaire</strong> : {information.companyName} –
        {information.address}
        <br />
        <strong>Responsable publication</strong> : {information.ownerName} –
        {information.phone}
        <br />
        Le responsable publication est une personne physique ou une personne
        morale.
        <br />
        <strong>Webmaster</strong> : {information.ownerName} –
        {information.email}
        <br />
        <strong>Hébergeur</strong> : {information.hostName} –
        {information.hostAddress} – {information.hostPhone}
        <br />
        <strong>Délégué à la protection des données</strong> : Cnil Cnil –
        delegue@cnil.com
        <br />
      </p>
      ...
      <p>
        ...
        <a href={information.siteLink}>{information.siteLink}</a>, qui
      ...
      <p>
        Le site internet
        <a href={information.siteLink}>{information.siteLink}</a>a pour objet de
        ...
        être tenu responsable des oublis, des inexactitudes et des carences dans
      ...
      <p>
        ...
        matériel informatique et de téléphonie lié notamment à l’encombr /ement
      ...
      <p>
        ...
        préalable de :<a href={information.siteLink}>{information.siteLink}</a>.
      </p>
      <p>
      ...
      <p>
        ...
        <a href={information.siteLink}>{information.siteLink}</a>, et résultant
      ...
      <p>
        ...
        par exemple qu’une perte de marché ou perte d’une chance) consécutifs à
        l’utilisation du site
        <a href={information.siteLink}>{information.siteLink}</a>. Des espaces
      ...
      <p>
        ...
        responsable du traitement des Données Personnelles est :
        {information.companyName}.
        <a href={information.siteLink}>{information.siteLink}</a>
        est représenté par {information.ownerName}, son représentant légal
      </p>
      <p>
        ...
        <a href={information.siteLink}>{information.siteLink}</a>
        prend toutes les mesures raisonnables pour s’assurer de l’exactitude et
        de la pertinence des Données Personnelles au regard des finalités pour
        lesquelles
        <a href={information.siteLink}>{information.siteLink}</a>
        les traite.
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          <a href={information.siteLink}>{information.siteLink}</a>: adresse
          email
        </li>
        <li>
      ...
      <p>
        Dès que
        <a href={information.siteLink}>{information.siteLink}</a>a connaissance
        du décès d’un Utilisateur et à défaut d’instructions de sa part,
        <a href={information.siteLink}>{information.siteLink}</a>
      ...
      {information.companyName} – DPO, Cnil Cnil <br /> {information.address}
      <p>
      ...
      <p>
        ...
        européenne ou reconnu comme « non adéquat » par la Commission européenne
        sans en informer préalablement le client. Pour autant,
        <a href={information.siteLink}>{information.siteLink}</a>
        reste libr /e du choix de ses sous-traitants techniques et commerciaux à
      ...
      <p>
        ...
        <a href={information.siteLink}>{information.siteLink}</a>, celle-ci
        devra dans les meilleurs délais informer le Client et lui communiquer
        les mesures de corrections prises. Par ailleurs
        <a href={information.siteLink}>{information.siteLink}</a>
      ...
      <p>
        ...
        Si nous prenions connaissance d'une br /èche de la sécurité, nous
      ...
      <p>
        Le site
        <a href={information.siteLink}>{information.siteLink}</a>
        contient un certain nombr /e de liens hypertextes vers d’autres sites,
        mis en place avec l’autorisation de
        <a href={information.siteLink}>{information.siteLink}</a>. Cependant,
        <a href={information.siteLink}>{information.siteLink}</a>
      ...
      <p>
        <a href={information.siteLink}>{information.siteLink}</a>
        est susceptible de traiter les informations de l’Utilisateur concernant
        sa visite du Site, telles que les pages consultées, les recherches
      ...
      <p>
        ...
        par
        <a href={information.siteLink}>{information.siteLink}</a>, résultant (i)
      ...
      <p>
        ...
        <a href={information.siteLink}>{information.siteLink}</a>, Twitter,
        Facebook, Linkedin et Google Plus peuvent également déposer des cookies
        sur vos terminaux (ordinateur, tablette, téléphone portable).
      </p>
      <p>
        ...
        <a href={information.siteLink}>{information.siteLink}</a>. À tout
        moment, l’Utilisateur peut néanmoins revenir sur son consentement à ce
        que
        <a href={information.siteLink}>{information.siteLink}</a>
      ...
      <p>
        ...
        actions (par exemple, le nombr /e de fois où une page est ouverte et les
      ...
      <p>
        ...
        <a href={information.siteLink}>{information.siteLink}</a>, et fournir
